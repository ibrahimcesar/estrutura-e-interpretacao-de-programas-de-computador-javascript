...
comparada à eficácia de usar a máquina Fibonacci de propósito especial da Figura 5.12. (Para medida do desempenho interpretado, veja o exercício 5.30.) Para Fibonacci, o recurso de tempo usado não é linear em *n*; portanto as razões de operações de pilha não se aproximarão de um valor limite que seja independente de *n*.

<Solution exercise="5.49">
...
Com o mecanismo do texto (interpretado→compilado) e este (compilado→interpretado), os dois mundos se chamam livremente — a condição para o sistema misto do exercício 5.51.
