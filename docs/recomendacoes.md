...
**[The Little Schemer](https://mitpress.mit.edu/9780262560993/the-little-schemer/)** - Daniel P. Friedman e Matthias Felleisen
...
**[How to Design Programs](https://htdp.org/)** - Matthias Felleisen et al.
...
**[Programming Language Pragmatics](https://www.cs.rochester.edu/~scott/pragmatics/)** - Michael L. Scott
...
**[MIT 6.037 Structure and Interpretation of Computer Programs](https://web.mit.edu/6.001/6.037/)**

- Versão mais recente do curso
- Adaptada para JavaScript

**[CS 61A: Structure and Interpretation of Computer Programs (Berkeley)](https://cs61a.org/)**
...
**[Lambda: The Ultimate...](http://library.readscheme.org/page1.html)** - Guy Steele e Gerald Sussman
...
**[Growing a Language](https://www.youtube.com/watch?v=_ahvzDzKdB0)** - Guy Steele (Palestra)
...
**[GitHub Discussions - SICP.js PT-BR](https://github.com/ibrahimcesar/estrutura-e-interpretacao-de-programas-de-computador-javascript/discussions)**

- Nossa comunidade oficial
- Tire dúvidas, compartilhe descobertas e contribua

**[r/brasil_programacao](https://www.reddit.com/r/brasil_programacao/)**
...
1. **[Abra uma discussão](https://github.com/ibrahimcesar/estrutura-e-interpretacao-de-programas-de-computador-javascript/discussions/categories/geral)** sugerindo o recurso
2. **[Contribua diretamente](https://github.com/ibrahimcesar/estrutura-e-interpretacao-de-programas-de-computador-javascript/edit/main/docs/recomendacoes.md)** editando esta página
