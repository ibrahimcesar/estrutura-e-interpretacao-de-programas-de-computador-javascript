...
graph TB
    Q["queue"] --> QP["●|●"]
    QP -->|"front_ptr<br/>(head)"| F1["●|●"]
    QP -->|"rear_ptr<br/>(tail)"| F3["●|null"]
    ...
    style QP fill:#bdf,stroke:#333,stroke-width:2px
    style F1 fill:#dfd,stroke:#333
    style F2 fill:#dfd,stroke:#333
...
graph TB
    Q["queue"] --> QP["●|●"]
    QP -->|"front_ptr"| F1["●|●"]
    QP -.->|"rear_ptr<br/>(antigo)"| F3["●|●"]
    QP ==>|"rear_ptr<br/>(novo)"| F4["●|null"]
...
graph TB
    Q["queue"] --> QP["●|●"]
    QP -.->|"front_ptr<br/>(antigo)"| F1["●|●"]
    QP ==>|"front_ptr<br/>(novo)"| F2["●|●"]
    QP -->|"rear_ptr"| F3["●|null"]
