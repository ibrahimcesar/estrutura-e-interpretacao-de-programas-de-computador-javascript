...
graph LR
    ...
    style Header fill:#ffe,stroke:#333
    style S1 fill:#dfd,stroke:#333
    style S2 fill:#dfd,stroke:#333
    style S3 fill:#dfd,stroke:#333
    style R1 fill:#fcf,stroke:#333
    style R2 fill:#fcf,stroke:#333
    style R3 fill:#fcf,stroke:#333
    style K1 fill:#efe,stroke:#333
    style K2 fill:#efe,stroke:#333
    style K3 fill:#efe,stroke:#333
    style V1 fill:#efe,stroke:#333
    style V2 fill:#efe,stroke:#333
    style V3 fill:#efe,stroke:#333
```
...
graph TB
    ...
    style Table fill:#ffd,stroke:#333,stroke-width:2px
    style TH fill:#bdf,stroke:#333,stroke-width:2px
    style Header fill:#ffe,stroke:#333
    style SubM fill:#fcf,stroke:#333,stroke-width:2px
    style SubL fill:#fcf,stroke:#333,stroke-width:2px
    style MathTable fill:#cef,stroke:#333,stroke-width:2px
    style LetterTable fill:#cef,stroke:#333,stroke-width:2px
    style KeyM fill:#ffc,stroke:#333
    style KeyL fill:#ffc,stroke:#333
```
