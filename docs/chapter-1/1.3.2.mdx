...
ou, de forma mais geral, em qualquer contexto onde normalmente usaríamos um nome de função.<a name="footnote-link-3"></a>[<sup>3</sup>](#footnote-3)
